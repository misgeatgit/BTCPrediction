...
'''
@click.command()
@click.option('--root-dir',  help='The parent dir of the LA_* dirs.',
        prompt='Root directory')
@click.option('--rank-size', type=int, default=10, help='How many models to rank.',
        prompt='Rank size.')
def main(root_dir, rank_size):
