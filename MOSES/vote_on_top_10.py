...
for i in range(10):
    ...
    df = top_5_metrics_df['program'][i]
    #path = top_5_metrics_df['experiment_dir'][10*i]
    path = top_5_metrics_df['experiment_dir'][i]
    print('INFO: Selected:\n{} \n{}'.format(df, path))
...
df_train['vote'] = [ 1 if v >=7 else 0 for  v in vote_train]
...
df_test['vote'] = [ 1 if v >=7 else 0 for  v in vote_test]
